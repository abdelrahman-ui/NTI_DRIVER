...
/***********************************************************  Start_FUNCTION  ***********************************************************/
 ...
 {
	 /* I can check that peripheral <= 32 or nor if go else return error : How can i return error */
	 switch(BusName) 
	 {
		 case AHB1_BUS :
...
void MRCC_voidDisableClock (BusName_t BusName ,u8 Copy_u8PerName )
 {
	 ...
	 switch(BusName) 
	 {
		 ...
		 case AHB3_BUS  :
			 CLR_BIT(RCC_AHB3ENR , Copy_u8PerName  ) ;
		 break ;
...
/*********************************************************** END_ FUNCTION   ***********************************************************/
 ...
 /*
void MRCC_vInitCLK(void)
{
// READ FROM CONFIG
#if RCC_CLK_TYPE == ( HSE_CRYSTAL )

#elif RCC_CLK_TYPE == ( HSE_RC )

#elif RCC_CLK_TYPE == ( HSI )

#elif RCC_CLK_TYPE == ( PLL )
